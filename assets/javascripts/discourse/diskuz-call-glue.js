...
apiInitializer("0.7", (api) => {
  ...
  ajax("/diskuz-call/status")
    .then((data) => {
      ...
      window.DiskuzCallVideoEnabledMobile = data.video_enabled_mobile === true;
      window.DiskuzCallVideoEnabledDesktop = data.video_enabled_desktop === true;
      LOG("glue: status OK enabled=", window.DiskuzCallAllowed, "video_mobile=", window.DiskuzCallVideoEnabledMobile, "video_desktop=", window.DiskuzCallVideoEnabledDesktop, "ice_servers=", window.DiskuzCallIceServers ? "custom" : "default");
    ...
    .catch((err) => {
      ...
      window.DiskuzCallVideoEnabledMobile = false;
      window.DiskuzCallVideoEnabledDesktop = false;
